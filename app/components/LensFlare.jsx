...
function NavItems({ items }) {
  ...
  const DEVICE = {
    ...
    desktop: { max: 1023, spacing: 0.3, fontSize: 0.015 },
  }
  const getDevice = () => {
  ...
  return (
    <group ref={group}>
      ...
      <Image
        ...
        scale={[1, 3, 1]}
        url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGNxkDj7TsLrReDW-Cl6Ws2TbJUQ5B557xQQ&s"
      />
      <Image
        position={[-0.6, -height, 9]}
        scale={[1, 2, 1]}
        url="https://media.licdn.com/dms/image/v2/D4E0BAQHCZnpsM4SAaw/company-logo_200_200/company-logo_200_200/0/1715841769306?e=2147483647&v=beta&t=h3a4tky6NqS2lh5BUsOvpJAGnl4MnlUMAiRE8vQ8h_I"
      />
      <Image
        position={[0.75, -height, 10.5]}
        scale={1.5}
        url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsS4Euv25iOmQHe2B5SIzPf0SPwdCFQAM7yg&s"
      />
    </group>
  )
}
